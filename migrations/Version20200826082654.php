 ...
 */
final class Version20200826082654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD remaining DOUBLE PRECISION DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE total_advance total_advance DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE description CHANGE estimate_id estimate_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE estimate CHANGE user_id user_id INT DEFAULT NULL, CHANGE customer_id customer_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE invoice DROP remaining, CHANGE user_id user_id INT DEFAULT NULL, CHANGE total_advance total_advance DOUBLE PRECISION DEFAULT \'NULL\'');
